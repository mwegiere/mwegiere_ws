...
def czytanieMacierzyT01():
	...
	if szachownica:
		...
		szachownica_przesuniecie = open("../../wyniki/szachownica_przesuniecie", "wb")
	 	szachownica_przesuniecie_x = open("../../wyniki/szachownica_przesuniecie_x", "wb")
		szachownica_przesuniecie_y = open("../../wyniki/szachownica_przesuniecie_y", "wb")
		szachownica_przesuniecie_z = open("../../wyniki/szachownica_przesuniecie_z", "wb")
	...
	with open("/home/mwegiere/ws_irp6/mwegiere_ws/src/serwo/diodRecogniotion/weryfikacja/"+plik1) as textfile1, open("/home/mwegiere/ws_irp6/mwegiere_ws/src/serwo/diodRecogniotion/weryfikacja/"+plik2) as textfile2:	
		for x, y in izip(textfile1, textfile2):
			...
			if (licznikWierszy%16 == 15 ):
				...
				if szachownica:
					...
					szachownica_przesuniecie_x.write(str(Taa.item(0,3))+"\n")
					szachownica_przesuniecie_y.write(str(Taa.item(1,3))+"\n")
					szachownica_przesuniecie_z.write(str(Taa.item(2,3))+"\n")
				...
				if szachownica:
					szachownica_obroty.write(str(odlegloscOrientacji)+"\n")
		...
		if szachownica:
			...
			szachownica_przesuniecie.close()
	 		szachownica_przesuniecie_x.close()
			szachownica_przesuniecie_y.close()
			szachownica_przesuniecie_z.close()		
